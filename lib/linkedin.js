...
// LinkedIn versions its REST API monthly; override via env if they sunset this one.
function apiVersion() { return process.env.LINKEDIN_API_VERSION || '202506'; }
...
module.exports = { isConfigured, authUrl, exchangeCode, getOrganizations, publishToOrg, deleteOrgPost, SCOPES };
