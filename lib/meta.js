...
// Only the permissions the app actually uses (keeps App Review lean).
const SCOPES = [
...
module.exports = { isConfigured, absMedia, authUrl, exchangeCode, getConnections, publishToPage, publishToInstagram, deletePost, SCOPES };
