...
function seedDemoUsers() {
  ...
  const demo = [
    ...
    { id: 'f-corporate', email: 'corporate@biooneinc.com', name: 'Corporate Admin', location: 'Bio-One Inc. HQ',            role: 'admin' }
  ];
  for (const u of demo) {
    const salt = crypto.randomBytes(16).toString('hex');
    store.addUser({ ...u, salt, passwordHash: hashPassword('demo', salt) });
  }
}
seedDemoUsers();
...
module.exports = { login, logout, userForToken, register, createResetToken, resetPassword };
