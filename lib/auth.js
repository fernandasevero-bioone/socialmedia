...
// franchisee roster.
const USERS = [
  { id: 'f-modesto',  email: 'modesto@biooneinc.com',  password: 'demo', name: 'Patricia Smith', location: 'Bio-One of Modesto, CA' },
  { id: 'f-alabama',  email: 'alabama@biooneinc.com',  password: 'demo', name: 'James Carter',   location: 'Bio-One of Birmingham, AL' },
  { id: 'f-corporate', email: 'corporate@biooneinc.com', password: 'demo', name: 'Corporate Admin', location: 'Bio-One Inc. HQ' }
];
...
function publicUser(u) {
  return { id: u.id, email: u.email, name: u.name, location: u.location };
}
